    ...
    >
      <View>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={{ flex: 1 }}>
            <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontSize: 18, fontWeight: "800", marginTop: 7 }}>
              {item.name}
            </Text>
            <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontWeight: "400", marginTop: 2 }}>
              {item.cuisines}
            </Text>
            <Text numberOfLines={1} ellipsizeMode="tail" style={{ fontWeight: "400", marginTop: 2 }}>
              {item.time}
  ...
  return (
    <View>
      <FlatList
        ...
        keyExtractor={(item) => item.id.toString()} // Assuming id is a number, use toString()
      />
    </View>
  );
};
